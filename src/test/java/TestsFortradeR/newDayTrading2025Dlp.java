...
public class newDayTrading2025Dlp extends BaseTest {
    ...
    public void setup() throws MalformedURLException, URISyntaxException {
        ...
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=age-annual-saving-knowledge-plang:all");
    ...
    public void assertInvalidTokenMsg() throws IOException {
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=sms-age-annual-saving-knowledge-plang:all");
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void checkingInvalidFtsQueryInTheCrm() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=age-annual-saving-knowledge&" +
                "ftsquery=age-equals(1,2)-and-[[annual-notequals(2,3)-or-saving-equals(3)]-and-[knowledge-equals(1,2)-or-plang-notequals(1)]]&" +
                "tg=ivanA1434&tag1=ivanB@1434&tag2=ivanL1434&tag3=ivanM1434&gid=ivanC@1434&G_GEO=ivanD1434&G_GEOint=ivanE1434&G_" +
                "Device=ivanF1434&G_DeviceModel=ivanG1434&G_AdPos=ivanH1434&g_Track=ivanI1434&Track=ivanj1434&gclid=ivanK1434");
        String url = driver.getCurrentUrl();
    ...
    public void checkingAgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=age");
    ...
    public void checkingAnnualParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=annual");
    ...
    public void checkingSavingParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=saving");
    ...
    public void checkingKnowledgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=knowledge");
    ...
    public void checkingPLangParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=plang:all");
    ...
    public void checkLogoClickability() throws IOException {
        fortraderPage.clickLogo("https://www.fortrader.com/minilps/en/new-day-trading-2025-dlp/?fts=age-annual-saving-knowledge-plang:all");
