...
public class euro_dollar_trading_dlp extends BaseTest {
    ...
    public void setup() throws MalformedURLException, URISyntaxException {
        ...
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=age-annual-saving-knowledge-plang:all");
    ...
    public void assertInvalidTokenMsg() throws IOException {
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=sms-age-annual-saving-knowledge-plang:all");
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void checkingAgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=age");
    ...
    public void checkingAnnualParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=annual");
    ...
    public void checkingSavingParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=saving");
    ...
    public void checkingKnowledgeParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=knowledge");
    ...
    public void checkingPLangParameter() throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortraderPage.getDriver("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=plang:all");
    ...
    public void didNotGetToken() throws InterruptedException, IOException {
        driver.get("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=sms-age-annual-saving-knowledge");
    ...
    public void checkLogoClickability() throws IOException {
        fortraderPage.clickLogo("https://www.fortrader.com/minilps/en/euro-dollar-trading-dlp/?fts=age-annual-saving-knowledge-plang:all");
