...
public class newDayTrading2025Dlp extends BaseTest {
    ...
    protected void setup(String tag) throws MalformedURLException, URISyntaxException {
        ...
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?" + tag + "&fts=age-annual-saving-knowledge-plang:all");
    ...
    protected void assertInvalidTokenMsg(String tag, String countryCode, String regulation) throws IOException {
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?" + tag + "&fts=sms-age-annual-saving-knowledge-plang:all");
    ...
    protected void anAlreadyRegisteredPhone(String countryCode, String tag, String regulation) throws IOException {
        ...
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?" + tag);
    ...
    public void checkingTagsInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void checkingDummyFtsQueryInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?fts=age-annual-saving-knowledge-plang:all&" +
    ...
    public void checkingInvalidFtsQueryInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?fts=age-annual-saving-knowledge&" +
                "ftsquery=age-equals(1,2)-and-[[annual-notequals(2,3)-or-saving-equals(3)]-and-[knowledge-equals(1,2)-or-plang-notequals(1)]]&" +
                "tg=ivanA1434&tag1=ivanB@1434&tag2=ivanL1434&tag3=ivanM1434&gid=ivanC@1434&G_GEO=ivanD1434&G_GEOint=ivanE1434&G_" +
                "Device=ivanF1434&G_DeviceModel=ivanG1434&G_AdPos=ivanH1434&g_Track=ivanI1434&Track=ivanj1434&gclid=ivanK1434" + tag);
        String url = driver.getCurrentUrl();
    ...
    public void checkingAgeParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?fts=age&" + tag);
    ...
    public void checkingAnnualParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?fts=annual&" + tag);
    ...
    public void checkingSavingParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?fts=saving&" + tag);
    ...
    public void checkingKnowledgeParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?fts=knowledge&" + tag);
    ...
    public void checkingPLangParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?fts=plang:all&" + tag);
    ...
    public void didNotGetToken(String tag,String countryCode,String regulation) throws InterruptedException, IOException {
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?" + tag + "&fts=sms-age-annual-saving-knowledge");
    ...
    public void userIsReturnedTo1stWidget(String tag,String countryCode,String regulation) throws IOException {
        driver.get("https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?" + tag + "&fts=sms-age-annual-saving-knowledge");
    ...
    public void checkLogoClickability(String regulation, String tag) throws IOException {
        fortradePage.clickLogo(regulation,"https://www.fortrade.com/minilps/en/new-day-trading-2025-dlp/?"+tag+"&fts=age-annual-saving-knowledge-plang:all");
