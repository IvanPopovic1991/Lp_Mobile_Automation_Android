...
public class newDayTradingOldman2025Dlp extends BaseTest {
    ...
    protected void setup(String tag) throws MalformedURLException, URISyntaxException {
        ...
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?" + tag + "&fts=age-annual-saving-knowledge-plang:all");
    ...
    protected void assertInvalidTokenMsg(String tag, String countryCode, String regulation) throws IOException {
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?" + tag + "&fts=sms-age-annual-saving-knowledge-plang:all");
    ...
    protected void anAlreadyRegisteredPhone(String countryCode, String tag, String regulation) throws IOException {
        ...
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?" + tag);
    ...
    public void checkingTagsInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void checkingDummyFtsQueryInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?fts=age-annual-saving-knowledge-plang:all&" +
                "ftsquery=age-equals(1,2)-and-[[annual-notequals(2,3)-or-saving-equals(3)]-and-[knowledge-equals(1,2)-or-plang-notequals(1)]]&" + tag);
        ...
        fortradePage.ftsQueryParameter(url, "Testq", "Testa", email, countryCode,
                ...
                "Yes, from a relevant role in financial services", "English");
        startChromeBrowserOnDesktop();
        CrmPage crmPage = new CrmPage(chromeDriver);
        crmPage.checkCrmData(email, "Testq Testa", regulation);
    ...
    public void checkingEmptyFtsQueryInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?fts=age-annual-" +
                "saving-knowledge-plang:all&ftsquery=age-equals(4)-and-[[annual-equals(2,3)-or-saving-equals(1)]-" +
                "and-[knowledge-equals(4)-or-plang-notequals(1)]]&" + tag);
        String url = driver.getCurrentUrl();
        fortradePage.ftsQueryParameter(url, "Testq", "Testa", email, countryCode,
                TestData.numberGenerator(), "18-24", "Less than $15,000", "$25,000 – $50,000",
    ...
    public void checkingInvalidFtsQueryInTheCrm(String tag, String countryCode, String regulation) throws IOException, AWTException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?fts=age-annual-" +
                "saving-knowledge-plang:all&ftsquery=age-(1,2)-and-[[annual-notequals(2,3)-or-saving-equals(3)]" +
                "-and-[knowledge-equals(1,2)-or-plang-notequals(1)]]&" + tag);
        String url = driver.getCurrentUrl();
        fortradePage.ftsQueryParameter(url, "Testq", "Testa", email, countryCode,
                TestData.numberGenerator(), "18-24", "Less than $15,000", "$25,000 – $50,000",
    ...
    public void checkingAgeParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?fts=age&" + tag);
    ...
    public void checkingAnnualParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?fts=annual&" + tag);
    ...
    public void checkingSavingParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?fts=saving&" + tag);
    ...
    public void checkingKnowledgeParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?fts=knowledge&" + tag);
    ...
    public void checkingPLangParameter(String tag, String countryCode, String regulation) throws IOException, AWTException, InterruptedException {
        String email = TestData.emailGenerator();
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?fts=plang:all&" + tag);
    ...
    public void didNotGetToken(String tag,String countryCode,String regulation) throws InterruptedException, IOException {
        fortradePage.getDriver("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?" + tag + "&fts=sms-age-annual-saving-knowledge");
    ...
    public void userIsReturnedTo1stWidget(String tag,String countryCode,String regulation) throws IOException {
        driver.get("https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?" + tag + "&fts=sms-age-annual-saving-knowledge");
    ...
    public void checkLogoClickability(String regulation, String tag) throws IOException {
        fortradePage.clickLogo(regulation,"https://www.fortrade.com/minilps/en/new-day-trading-oldman-2025-dlp/?"+tag+"&fts=age-annual-saving-knowledge-plang:all");
    ...
    @Test
    @Parameters({"regulation"})
    public void checkLoginRedirection(String regulation) throws IOException, InterruptedException {
        fortradePage.clickAlrHaveAnAcc();
/*        try {
            if (driver.getCurrentUrl().equalsIgnoreCase(fortradePage.appUrl)) {
                fortradePage.takeScreenshot("Login redirection-user is redirected to the app " + regulation,fortradePage.);
            }
        } catch (Exception e) {
            System.out.println(e + "Wrong link redirection");
        }*/
        fortradePage.assertUrl(fortradePage.appUrl);
        Thread.sleep(1500);
        fortradePage.takeScreenshot("Login redirection - user is redirected to the app " + regulation);
    }
    ...
    @Test
    @Parameters({"regulation"})
    public void checkFCAPercentages(String regulation) throws IOException {
    ...
    @Test
    @Parameters({"regulation"})
    public void checkCysecPercentages(String regulation) throws IOException {
        fortradePage.checkPercentages("70.41% of retail investor accounts lose money when trading CFDs with this provider.");
        try {
            Thread.sleep(500);
        } catch (Exception e){
            System.out.println(e);
